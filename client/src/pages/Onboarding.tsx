...
import Slider from "../components/ui/Slider"; // Added based on screenshots
...
const ageRanges = [
  { max: 20, maintain: 2000, burn: 400 },
  { max: 30, maintain: 2100, burn: 400 },
  { max: 40, maintain: 2000, burn: 380 },
  { max: 50, maintain: 1900, burn: 350 },
  { max: 60, maintain: 1800, burn: 320 },
  { max: Infinity, maintain: 1700, burn: 300 },
];
...
const Onboarding = ({ setOnboardingCompleted }: OnboardingProps) => {
  ...
  const handleNext = async () => {
    ...
    if (step === 3) {
      const ageRange =
        ageRanges.find((range) => formData.age <= range.max) ||
        ...
        <div className="flex-1 px-6 onboarding-wrapper">
            ...
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">
                    Help us track your progress accurately
                  </p>
                </div>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-6 onboarding-wrapper">
              ...
              {/* Daily Targets Sliders from Screenshots */}

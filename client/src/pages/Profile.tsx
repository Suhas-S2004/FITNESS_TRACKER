...
const Profile = () => {
  const { user, allFoodLogs, allActivityLogs, fetchUser, logout } =
    useAppContext();
    ...
    <div className="page-container">
      ...
      <div className="profile-content">
          ...
          {isEditing ? (
            ...
            <div className="space-y-4">
              ...
              <Select
                label="Fitness Goal"
                value={formData.goal}
                onChange={(v: any) => setFormData({ ...formData, goal: v })}
                options={[
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  ...
                  onClick={() => {
                    setIsEditing(false);
                    fetchUserData(); // Reset form to original user data
                  }}
                >
                  Cancel
                </Button>
        ...
        <div className="space-y-4">
          ...
          {/* Toggle theme button for phone - Moved to second position */}
